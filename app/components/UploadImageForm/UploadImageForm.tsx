...
export default function UploadImageForm({ value, onDataChange, onSubmit }: UploadImageFormProps) {
    ...
    const handleFileChange =
        (field: 'fullImageFile' | 'thumbImageFile') => async (e: ChangeEvent<HTMLInputElement>) => {
                    ...
                    <div className="flex items-center gap-3">
                        <label className={fileButtonClass}>
                            ...
                            <input
                                type="file"
                                accept="image/*"
                                onChange={handleFileChange('fullImageFile')}
                                className="hidden"
                            />
                        </label>
                    ...
                    <div className="flex items-center gap-3">
                        <label className={fileButtonClass}>
                            ...
                            <input
                                type="file"
                                accept="image/*"
                                onChange={handleFileChange('thumbImageFile')}
                                className="hidden"
                            />
                        </label>
                        <span className="text-sm text-gray-500 truncate">
